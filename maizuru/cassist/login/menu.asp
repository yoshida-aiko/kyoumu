...
<!--2003/07/07 del takada <tr><td><a class=menu href="../sei/sei0800/" target="<%=C_MAIN_FRAME%>">成績参照</a></td></tr> -->
	...
	<% End If%>
		<% '舞鶴高専は表示する 2021.06.21 Yoshimura%>
		<% if Cint(m_SchoolNo) = Cint(C_NCT_MAIZURU) then %>
			<% if gf_empMenu("SEI0200") then %><tr><td><a class=menu href="../sei/sei0700/default.asp?p_mode=P_SSK0200_28" target="<%=C_MAIN_FRAME%>">成績通知書</a></td></tr><% End if %>
		<% End If%>
