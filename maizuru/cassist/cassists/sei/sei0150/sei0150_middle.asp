...
'/////////////////////////// ﾓｼﾞｭｰﾙ変数 /////////////////////////////
	...
	dim m_KekkaDispFlg		'//欠課表示フラグ 2002.11.21
...
Sub s_SetParam()
	...
	m_KekkaDispFlg= cbool(request("hidKekkaDispFlg"))
	...
	<table border="0" cellpadding="0" cellspacing="0" height="245" width="100%">
		...
		<tr>
			<td align="center">
				...
				<%if m_KekkaDispFlg and m_KekkaGaiDispFlg then%>※「対象外」は、公欠などの累計を入力してください。<br><%end if%>
		...
		<tr>
			<td align="center" valign="bottom" nowrap>
				<table class="hyo" border="1" align="center" width="<%=m_TableWidth%>">
					...
					<tr><th class="header3" colspan="10" nowrap align="center">
							<! -- 総時間、純時間削除 -->
					...
					<tr>
						...
						<th class="header3" colspan="2" width="80" nowrap>成績履歴</th>
						...
						<% end if %>
						<% if m_KekkaDispFlg then 	'欠課入力フラグ=ON %>
					...
					<tr>
						<th class="header2" width="40" nowrap><span style="font-size:10px;">前末</span></th>
						<th class="header2" width="40" nowrap><span style="font-size:10px;">学末</span></th>
