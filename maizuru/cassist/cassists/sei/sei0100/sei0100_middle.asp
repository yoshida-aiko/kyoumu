				...
				<% If m_TUKU_FLG = C_TUKU_FLG_TUJO Then %>
					...
					<table class="hyo" border="1" align="center" width="710">
						<tr><th class="header3" colspan="13" nowrap align="center">
								総授業数&nbsp;<%If m_iKikan <> "NO" or m_bKekkaNyuryokuFlg Then%><input type="text" <%=w_sInputClass%> maxlength="3" style="width:30px" name="txtSouJyugyou" value="<%= Request("hidSouJyugyou") %>"><% Else %><%= Request("hidSouJyugyou") %><% End if%>　
								純授業数&nbsp;<%If m_iKikan <> "NO" or m_bKekkaNyuryokuFlg Then%><input type="text" <%=w_sInputClass%> maxlength="3" style="width:30px" name="txtJunJyugyou" value="<%= Request("hidJunJyugyou") %>"><% Else %><%= Request("hidJunJyugyou") %><% End if%>　
							</th></tr>                                                                                                                                                 
						<tr>
