...
'******************************************************************
    ...
    Do
        ...
        w_sSQL = w_sSQL & " AND T16_KAMOKU_CD = '" & m_Krs("T15_KAMOKU_CD") & "' "
...
<%End If%>
	...
	<FORM NAME="frm" method="post">
        ...
        Do Until m_Krs.EOF
	        ...
	        <input type=hidden name=Tanisuu<%=n%> value="<%=m_Krs("T15_HAITO"&Cint(m_sGakunen)&"")%>">
		    <%
	        m_Krs.MoveNext
        Loop%>
	<table class=hyo border=1>
	    ...
	    <%
	        ...
	        Do Until m_Grs.EOF
			    ...
			    %>
			    <tr>
			        <td class=<%=m_cell%> width="50"><%=m_Grs("T13_GAKUSEKI_NO")%>
