...
' 作      成: 2001/07/02 岩田
' 変      更: 2001/07/02
' 変      更: 2003/08/30　西村　T13_NENSYOKENを取得し表示する
...
Function f_GetDetailGakunen()
	...
	Do
		...
		w_sSql = w_sSql & " 	A.T13_NENSYOKEN "			'INS 2003.08.29 西村
		w_sSql = w_sSql & " FROM  "
...
'					　  = "" 	'奨学金
	...
	m_NENSYOKEN			= ""	'年所見　INS 2003.08.29 西村
	...
	if Not m_Rs.Eof Then
		...
		m_NENSYOKEN = m_Rs("T13_NENSYOKEN")		'INS 2003.08.29 西村
