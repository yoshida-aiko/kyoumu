...
dim w_SLT_Sei,w_SLT_Kek,w_SLT_Tik '表示区分 選択
w_SLT_Sei="":w_SLT_Kek="":w_SLT_Tik=""

'// 強引ですが、リロードしたときの表示区分の選択処理です。
'// こんな初歩的方法ですみません。
Select case Request("txtHyojiKBN")
			...
			<tr><td class="search">
				...
				<table border="0">
					<tr>
						...
						<td>表示項目</td>
						<td><select name="txtHyojiKBN">
							<option value="<%=C_SEI0200_SEISEKI%>" <%=w_SLT_Sei%>>成　績　</option>
							<option value="<%=C_SEI0200_KEKKA%>" <%=w_SLT_Kek%>>欠課数　</option>
							<option value="<%=C_SEI0200_CHIKOKU%>" <%=w_SLT_Tik%>>遅刻数　</option>
							</select>
						</td>
					</tr>
					<tr>
...
<%End If%>
						...
						<td><%call gf_ComboSet("txtKBN",C_CBO_M01_KUBUN,m_sKBNWhere,"style='width:96px;' ",True,Request("txtKBN"))%></td>
					</tr>
					<tr>
