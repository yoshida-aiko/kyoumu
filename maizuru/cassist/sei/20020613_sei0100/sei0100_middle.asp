			...
			<td align="center"><form name="frm" method="post">
				<table border=1 class=hyo width=670>
					<tr>
						...
						成績入力期間　<%=m_sSikenNm%>　　　更新日：<%=gf_GetT16UpdDate(m_iNendo,m_sGakuNo_s,m_sGakkaCd_s,m_sKamokuCd_s,"")%>
						</th>
					</tr>
					<tr>
				...
				<% If m_TUKU_FLG = C_TUKU_FLG_TUJO Then '通常授業と特別活動で表示を変える。%>
					...
					<table class="hyo" border=1 align="center" width="555" nowrap>
						...
						<tr>
							...
							<th class="header3" rowspan="2" width="250" nowrap>氏　名</th>
							<th class="header3" colspan="4" width="100" nowrap>成績履歴</th>
							<th class="header3" rowspan="2" width="35" nowrap onClick="f_Paste('Seiseki')"><FONT COLOR="#99CCFF">成績</FONT></th>
							<th class="header3" rowspan="2" width="35" nowrap>評価</th>
							<th class="header3" colspan="2" width="80" nowrap>遅刻</th>
							<th class="header3" colspan="3" width="120" nowrap">欠課</th>
							
						</tr>
						<tr>
							<th class="header2" nowrap><span style="font-size:10px;">前中</FONT></span></th>
							<th class="header2" nowrap><span style="font-size:10px;">前末</span></th>
							<th class="header2" nowrap><span style="font-size:10px;">後中</span></th>
							<th class="header2" nowrap><span style="font-size:10px;">学末</span></th>
							<th class="header2" width="35" nowrap onClick="f_Paste('Chikai')"><span style="font-size:10px;"><FONT COLOR="#99CCFF">入力</FONT></span></th>
							<th class="header2" width="45" nowrap><span style="font-size:10px;">日々計</span></th>
							<th class="header2" width="35" nowrap onClick="f_Paste('Kekka')"><span style="font-size:10px;"><FONT COLOR="#99CCFF">対象</FONT></span></th>
							<th class="header2" width="40" nowrap onClick="f_Paste('KekkaGai')"><span style="font-size:10px;"><FONT COLOR="#99CCFF">対象外</FONT></span></th>
							<th class="header2" width="45" nowrap><span style="font-size:10px;">日々計</span></th>
						</tr>
					</table>
				<% else %>
					<table class="hyo" border=1 align="center" width="555" nowrap>
						...
						<tr>
							...
							<th class="header3" rowspan="2" width="35" nowrap onClick="f_Paste('Seiseki')"><FONT COLOR="#99CCFF">成績</FONT></th>
							<th class="header3" rowspan="2" width="35" nowrap>評価</th>
							<th class="header3" rowspan="2" width="80" nowrap onClick="f_Paste('Chikai')"><FONT COLOR="#99CCFF">遅刻</FONT></th>
							<!--th class="header3" rowspan="2" width="80" nowrap>遅刻</th-->
							<th class="header3" colspan="2" width="120" nowrap>欠課</th>
						</tr>
						<tr>
							<th class="header2" nowrap><span style="font-size:10px;">前中</FONT></span></th>
							<th class="header2" nowrap><span style="font-size:10px;">前末</span></th>
							<th class="header2" nowrap><span style="font-size:10px;">後中</span></th>
							<th class="header2" nowrap><span style="font-size:10px;">学末</span></th>
							<th class="header2" width="60" nowrap onClick="f_Paste('Kekka')"><span style="font-size:10px;"><FONT COLOR="#99CCFF">対象</FONT></span></th>
							<th class="header2" width="60" nowrap onClick="f_Paste('KekkaGai')"><span style="font-size:10px;"><FONT COLOR="#99CCFF">対象外</FONT></span></th>
						</tr>
					</table>
				<% end if %>
			</td>
