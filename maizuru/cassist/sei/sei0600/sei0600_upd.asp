...
'/////////////////////////// ﾓｼﾞｭｰﾙ変数 /////////////////////////////
	...
	Public  m_rCnt
	'--------------------- 2002/6/11 kanazawa 
	Public  m_iTokuCnt		'特別欠席名称のレコードカウント
	'---------------------
...
'********************************************************************************
	...
	m_iTokuCnt = cint(Request("txtTokuCnt"))	'特欠 kanazawa 2002/6/11
...
Function f_Update()
	...
	dim w_Gno,w_Kss,w_kbk,w_iSumTokuketu
	'-------- Kanazawa 2002/06/10 ------------------
	dim w_iNum
	Dim w_Type
	'-----------------------------------------------
    ...
    Do
		For i = 1 to m_rCnt 
			...
			'----------------------------- 2002/06/10 KANAZAWA ---------------------------------------
			FOR w_iNum = 1 To m_iTokuCnt
				w_sSQL = w_sSQL & vbCrLf & "	T13_TOKUKETU" & w_iNum & w_Type & " = " & gf_SetNull2Zero(Request(w_kbk & w_iNum & "_" & i)) & ","
				w_iSumTokuketu = w_iSumTokuketu + cint(Request(w_kbk & w_iNum & "_" & i))
			Next 
			
			w_sSQL = w_sSQL & vbCrLf & "   T13_SUMKIBTEI = '" & w_iSumTokuketu & "',"
			'-----------------------------------------------------------------------------------------
...
%>
    ...
    <form name="frm" method="post">
		...
		<input type="hidden" name="txtClassNm" value="<%=request("txtClassNm")%>">
