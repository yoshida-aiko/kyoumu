...
Sub s_MakeSQL(p_sSql)
	...
	Dim w_iGakunen
	Dim w_iClassNo
	Dim w_iClassNo2	'2018.10.05 Upd Kiyomoto 混合学級対応
	Dim w_sGakka
...
'response.write "getid" & w_sId
	...
	ReDim w_iClassNo2(0)	'2018.10.05 Add Kiyomoto 初期化
...
'				if Not f_GetClass(m_iSyoriNen,m_RsGakka("M23_GAKUNEN"),w_iClassNo,m_RsGakka("M23_GAKKA_CD")) then
				if Not f_GetClass(m_iSyoriNen,m_RsGakka("M23_GAKUNEN"),w_iClassNo,m_RsGakka("M23_GAKKA_CD")) then	'2018.10.05 Upd Kiyomoto 混合学級対応
					m_bErrFlg = True
...
'response.write w_sSql
	...
	'//データが取得できたとき
	If rs.EOF = False Then
		ReDim Preserve p_iClassNo(w_iCnt)
		p_iClassNo(w_iCnt) = rs("T13_CLASS")	'クラスNO
		w_iCnt = w_iCnt + 1
	End If
