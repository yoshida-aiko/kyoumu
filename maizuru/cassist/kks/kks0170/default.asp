...
' システム名: 教務事務システム
' 処  理  名: 日毎出欠入力
' ﾌﾟﾛｸﾞﾗﾑID : kks/kks0170/default.asp
' 機      能: フレームページ 日毎出欠入力を表示する
'-------------------------------------------------------------------------
...
<title>日毎出欠入力</title>
<frameset rows="160,1,*" frameborder="no">
    <frame src="kks0170_top.asp" scrolling="yes" noresize name="topFrame">
