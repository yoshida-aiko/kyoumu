...
%>
	...
	function f_SetData(){
    	...
    	//試験区分
		var taisyo = document.frm.sltShikenKbn.options[document.frm.sltShikenKbn.selectedIndex].text;
		//学年/クラス名/科目名
		taisyo = taisyo + "/" + document.frm.sltSubject.options[document.frm.sltSubject.selectedIndex].text.split('　').join('/').replace(/\/\s*$/, "");
