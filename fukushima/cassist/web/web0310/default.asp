...
' システム名: 教務事務システム
' 処  理  名: 連絡事項登録
' ﾌﾟﾛｸﾞﾗﾑID : web/web0310/default.asp
' 機      能: フレームページ 連絡事項登録を行う
'-------------------------------------------------------------------------
...
<frameset rows="110,1,*" frameborder="no">
    <frame src="web0310_top.asp" scrolling="auto" noresize name="top">
        <frame src="../../common/bar.html" scrolling="auto" noresize name="bar">
    <frame src="web0310_main.asp" scrolling="auto" noresize name="main">
</frameset>
...
<frameset rows="260,1,*" frameborder="no">
