...
'2009/08/06 Add Start =====
		'//クラブ1が空きでなく、入部、退部のどちらでもない場合、クラブ1に登録
		If gf_SetNull2String(p_T13_CLUB1) <> "" And gf_SetNull2String(p_iFlg1) = "0" Then
'response.write "クラブ1が空きでなく、入部、退部のどちらでもない場合、クラブ1に登録"
			p_bClub1 = True
			p_bClub2 = False
			p_sClubCd = m_sClubCd
			Exit Function
		...
		'//クラブ2が空きでなく、入部、退部のどちらでもない場合、クラブ2に登録
		If gf_SetNull2String(p_T13_CLUB2) <> "" And gf_SetNull2String(p_iFlg2) = "0" Then
'response.write "クラブ2が空きでなく、入部、退部のどちらでもない場合、クラブ2に登録"
			p_bClub1 = False
			p_bClub2 = True
			p_sClubCd = m_sClubCd
			Exit Function
