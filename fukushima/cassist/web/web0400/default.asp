...
<head>
	...
	<!--
		...
		while(1) {
			...
			//パスワードの入力チェック	//2023.10.25 Upd Kiyomoto パスワードを10桁⇒16桁に変
			w_nm = eval(document.frm.txtPass);
			w_str = w_nm.value;
			if (w_str == "") {w_str = "パスワードを入力してください。";break;}
			//if (!IsHankakuEisu(w_str)) {w_str = "パスワードが、半角英数文字ではありません。";break;}
			if (getLengthB(w_str) > 16 ) {w_str = "パスワードが、16文字以下ではありません。";break;}

			//パスワードの入力チェック	//2023.06.05 Upd Kiyomoto パスワードを10桁⇒16桁に変更
			w_nm = eval(document.frm.txtPassN1);
			w_str = w_nm.value;
			if (w_str == "") {w_str = "新しいパスワード(1)を入力してください。";break;}
			if (!IsHankakuEisu(w_str)) {w_str = "新しいパスワード(1)が、半角英数文字ではありません。";break;}
			if (getLengthB(w_str) > 16 ) {w_str = "新しいパスワード(1)が、16文字以下ではありません。";break;}

			//パスワードの入力チェック	//2023.06.05 Upd Kiyomoto パスワードを10桁⇒16桁に変更
			w_nm = eval(document.frm.txtPassN2);
			w_str = w_nm.value;
			if (w_str == "") {w_str = "新しいパスワード(2)を入力してください。";break;}
			if (!IsHankakuEisu(w_str)) {w_str = "新しいパスワード(2)が、半角英数文字ではありません。";break;}
			if (getLengthB(w_str) > 16 ) {w_str = "新しいパスワード(2)が、16文字以下ではありません。";break;}
...
<% End If %>
	        ...
	        <tr>
	            ...
	            <td nowrap class="detail">　<input type="password" name="txtPass" value="<%=m_sPass%>" maxlength="16"></td> <!-- 2023.10.25 Upd Kiyomoto パスワードを10桁⇒16桁に変更 -->
	        </tr>
	        <tr>
	            <td nowrap class="detail" align="right"></td>
	            <td nowrap class="detail">　<span class="CAUTION" style="text-align:left;">※半角英数16文字以内</span></td>
	        ...
	        <tr>
	            ...
	            <td nowrap class="detail">　<input type="password" name="txtPassN1" value="<%=m_sPassN1%>" maxlength="16"></td> <!-- 2023.10.25 Upd Kiyomoto パスワードを10桁⇒16桁に変更 -->
	        </tr>
	        <tr>
	            <td nowrap class="detail" align="right"></td>
	            <td nowrap class="detail">　<span class="CAUTION" style="text-align:left;">※半角英数16文字以内</span></td>
	        ...
	        <tr>
	            <td nowrap class="detail" align="right">新しいパスワード：</td>
	            <td nowrap class="detail">　<input type="password" name="txtPassN2" value="<%=m_sPassN2%>" maxlength="16"></td> <!-- 2023.10.25 Upd Kiyomoto パスワードを10桁⇒16桁に変更 -->
	        </tr>
	        <tr>
	            <td nowrap class="detail" align="right"></td>
			...
			<tr><td colspan="2" height="30" class="detail" align="center">
				<input type="submit" name="submit" value=" 変 更 " maxlength="16"> <!-- 2023.10.25 Upd Kiyomoto パスワードを10桁⇒16桁に変更 -->
	            　<input type="reset" name="can" value="ｷｬﾝｾﾙ" maxlength="10" onclick="location.href='../../default.asp';">
	            </td>
	        </tr>
		</FORM>
	</table>
