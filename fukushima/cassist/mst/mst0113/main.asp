...
'********************************************************************************
    ...
    Do
        ...
        w_sSQL = w_sSQL & vbCrLf & " 	M13_TYUGAKKO M13 ,"
        w_sSQL = w_sSQL & vbCrLf & " 	M16_KEN M16 ,"
        w_sSQL = w_sSQL & vbCrLf & " 	M12_SITYOSON M12 "
        w_sSQL = w_sSQL & vbCrLf & " WHERE " 
        w_sSQL = w_sSQL & vbCrLf & " 	M13.M13_KEN_CD = M16.M16_KEN_CD and "
        w_sSQL = w_sSQL & vbCrLf & " 	M13.M13_KEN_CD = M12.M12_KEN_CD and "
        w_sSQL = w_sSQL & vbCrLf & " 	M12.M12_YUBIN_BANGO LIKE '%00' and "
        w_sSQL = w_sSQL & vbCrLf & " 	M13.M13_SITYOSON_CD = M12.M12_SITYOSON_CD(+) and "
        w_sSQL = w_sSQL & vbCrLf & " 	M13.M13_NENDO = " & m_iNendo & " and "
        w_sSQL = w_sSQL & vbCrLf & " 	M13.M13_NENDO = M16.M16_NENDO(+) "
