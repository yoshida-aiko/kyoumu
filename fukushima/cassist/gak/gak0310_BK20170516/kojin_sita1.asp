...
'/////////////////////////// ﾓｼﾞｭｰﾙ変数 /////////////////////////////
	...
	Public m_SIBU_KBN		'支部区分
	
	Public m_HyoujiFlg		'表示ﾌﾗｸﾞ
	
	PRIVATE CONST C_DAIBUNRUI  = 151  '区分マスタの大分類ＣＤ
...
'20050412 ITO
		w_sSql = w_sSql & " 	A.T11_HOG_SITYOSON_CD, "
		w_sSql = w_sSql & " 	A.T11_HOS_SITYOSON_CD, "

		w_sSql = w_sSql & " 	A.T11_SIBU_KBN "
		w_sSql = w_sSql & " FROM  "
		w_sSql = w_sSql & " 	TT11_GAKUSEKI A "
		w_sSql = w_sSql & " WHERE "
		...
		'// 支部名を取得
		'C_DAIBUNRUI
		if Not gf_GetKubunName(C_DAIBUNRUI,m_Rs("T11_SIBU_KBN"),Session("HyoujiNendo"),m_SIBU_KBN) then Exit Do
...
'20050412 ITO
	m_HOG_SITYOSON_CD = m_Rs("T11_HOG_SITYOSON_CD")
	m_HOS_SITYOSON_CD = m_Rs("T11_HOS_SITYOSON_CD")
...
'	Call gf_ComvZip(m_Rs("T11_HOS_ZIP"),m_Ken2,m_SITYOSONCD2,m_SITYOSONMEI2,m_TYOIKIMEI2,Session("HyoujiNendo"))
	Call gf_ComvZip2(m_HOG_SITYOSON_CD,m_Rs("T11_HOG_ZIP"),m_Ken,m_SITYOSONCD,m_SITYOSONMEI,m_TYOIKIMEI,Session("HyoujiNendo"))
	Call gf_ComvZip2(m_HOS_SITYOSON_CD,m_Rs("T11_HOS_ZIP"),m_Ken2,m_SITYOSONCD2,m_SITYOSONMEI2,m_TYOIKIMEI2,Session("HyoujiNendo"))
		...
		<tr>
			...
			<td valign="top" align="left">
					...
					<table border="1" width="220" class="disp">
						...
						<% if gf_empItem(C_T11_SIBU_KBN) then %>
							<tr>
								<td class="disph" height="16"><font color="white">支　　　　部</font></td>
								<td class="disp"><%= m_SIBU_KBN %>&nbsp</td>
							</tr>
						<% End if %>
					</table>
			<br>
