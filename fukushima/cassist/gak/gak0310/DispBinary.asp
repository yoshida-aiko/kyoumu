...
' 変      更: 2022/06/01 清本　oo4o廃止により画像データ読み込み方法を変更
'*************************************************************************/
%>
...
'/////////////////////////// ﾓｼﾞｭｰﾙ変数 /////////////////////////////
    ...
    Public  m_Rs		   'recordset	'2022.06.01 ADD kiyomoto
...
'********************************************************************************
	...
	Dim w_iRet              '// 戻り値	'2022.06.01 ADD kiyomoto
    Dim w_sSQL              '// SQL文	'2022.06.01 ADD kiyomoto
