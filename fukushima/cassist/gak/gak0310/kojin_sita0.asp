...
' 変      更: 2017/05/15 西村 学生写真データSession作成は global.aspで行う。
'*************************************************************************/
%>
			...
			<td valign="top" rowspan="2">
				...
				<table border="1" class="disp">
					<tr><td class="disp">
						...
						if w_bRet = True then
							' 2011.04.05 upd DispBinary => DispBinaryRec に変更 => ' 2022.06.01 upd DispBinaryRec => DispBinary に変更
							%><IMG SRC="DispBinary.asp?gakuNo=<%= Session("GAKUSEI_NO") %>" width="90" height="120" border="0"><%
						Else
