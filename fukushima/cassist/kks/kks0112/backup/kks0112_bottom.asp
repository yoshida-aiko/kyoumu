...
function f_Get_Student()
	...
	w_sSQL = w_sSQL & "  T11.T11_SIMEI,T13.T13_GAKUSEKI_NO,T21.T21_JIKANSU,T21.T21_SYUKKETU_KBN,T16.T16_HISSEN_KBN,T16.T16_SELECT_FLG "
...
%>
	...
	function chg(chgInp){
		...
		w_txtKekka = eval("top.topFrame.document.frm.txtKekka");
		...
		for(i=0;i<4;i++){
			if(top.topFrame.document.frm.rdoType[i].checked == true){
				w_num = i + 1;
				...
				<td align="center" valign="top" nowrap>
					<table class="hyo"	border="1" width="300">
						...
						Do until m_Rs_Student.EOF
							...
							w_HissenFlg = cint(m_Rs_Student("T16_HISSEN_KBN"))	'必修・選択フラグ
							w_SelectFlg = cint(m_Rs_Student("T16_SELECT_FLG"))	'選択授業を選択しているかフラグ
