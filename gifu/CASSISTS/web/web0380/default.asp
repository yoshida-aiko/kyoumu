...
'response.write m_rs("T11_SIMEI") & "<BR>"
'response.write m_rs("T13_GAKUNEN") & "<BR>"
'response.write m_rs("M02_GAKKAMEI") & "<BR>"
'response.write m_rs("M05_CLASSMEI") & "<BR>"
'response.write m_rs("T13_GAKUSEKI_NO") & "<BR>"
'response.write m_rs("T13_GAKUSEI_NO") & "<BR>"
'response.write w_rs("IDO_KBN") & "<BR>"
'response.write w_rs("IDO_BI") & "<BR>"
'response.write w_rs("IDO_BI_E") & "<BR>"
'response.write w_rs("IDO_BIK") & "<BR>"
'response.write "w_iCnt = " & w_iCnt & "<BR>"
...
<table border=0 cellpaddin="0" cellspacing="0" width="98%">
	...
	<tr><td><% Call s_pageBar((Ubound(m_sHiduke)),m_iNowPage,m_iPagesize) %></td></tr>
	<tr>
		<td>
