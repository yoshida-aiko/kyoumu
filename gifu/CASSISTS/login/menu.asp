...
Select Case p_menu
	...
	<% Case "SHIKEN" %>
		...
		<% if m_sGakkoNO = cstr(C_NCT_GIFU) AND gf_empMenu("SEI0200") then %><tr><td><a class=menu href="../sei/sei0700/default.asp?p_mode=P_KKS0200" target="<%=C_MAIN_FRAME%>">欠課一覧</a></td></tr><% End if %>
