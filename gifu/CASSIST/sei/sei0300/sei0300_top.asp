...
'-------------------------------------------------------------------------
' 作      成: 2001/09/04 伊藤公子
' 変      更: 2020.01.20 Ins Kiyomoto [条件追加]担任の場合は学年選択、クラス選択を行わない(Chromeがdisabledの値を送信しない為)
'*************************************************************************/
%>
...
%>
	...
	<%If m_sKengen <> C_KENGEN_SEI0300_TAN Then%>	//2020.01.20 Ins Kiyomoto
		// ■■■NULLﾁｪｯｸ■■■
		// ■学年
	...
	<%End If%>
	<%If m_sKengen <> C_KENGEN_SEI0300_GAK and m_sKengen <> C_KENGEN_SEI0300_TAN Then%>	//2020.01.20 Upd Kiyomoto
		// ■クラス
