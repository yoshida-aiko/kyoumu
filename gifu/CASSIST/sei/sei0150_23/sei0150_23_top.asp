...
' システム名: 教務事務システム
' 処  理  名: 成績登録
' ﾌﾟﾛｸﾞﾗﾑID : sei/sei0150_23/sei0150_23_top.asp
' 機      能: 上ページ 成績登録の検索を行う
'-------------------------------------------------------------------------
' 引      数:
'           :
...
'-------------------------------------------------------------------------
' 作      成: 2003/05/01 廣田
' 変      更: 2022/12.20 清本 カリキュラムにない個人履修追加科目も開設時期によって科目の表示を制御する
'*************************************************************************/
%>
...
Function f_GetSubject()
	...
	w_sSQL = w_sSQL & "    AND T27_GAKUNEN = M05_GAKUNEN "
	w_sSQL = w_sSQL & "    AND T27_CLASS = M05_CLASSNO	"
	w_sSQL = w_sSQL & "    AND T27_GAKUNEN = T16_HAITOGAKUNEN(+)"	'2022.12.20 Add Kiyomoto
...
%>
	...
	function f_ReLoadMyPage(){
		document.frm.action="sei0150_23_top.asp";
