...
' 更　　　新: 2018/06/28 西村 和暦元号を関数より取得するように変更(新元号対応)
' 更　　　新: 2020/01/15 Chromeで印刷できるように修正
' 更　　　新: 2022/09/27 藤林 ヘッダ項目の縦書きが正しく表示されるように修正
'*************************************************************************/
%>
...
' 引　　数：p_sNendo - 西暦の年度
' 詳細機能：西暦年度から和暦年度を求める
' 備　　考："元号99年度"形式(例："平成13年度")のテキストで返す
'***********************************************************
Function f_ConvWareki_Nendo(p_iNendo)
   ...
   '== 初期化 ==
    ...
    f_ConvWareki_Nendo = gf_SetNull2String(w_Rs("M09_GENGOMEI"))
...
<!--
	...
	window.focus();
	window.print();
	//document.frm.target = "main";　//delete 2020/01/15 huy 
	//document.frm.action = "sei0150_23_bottom.asp" //delete 2020/01/15 huy
	//document.frm.submit(); //delete 2020/01/15 huy
	}
	//ADD START 2020/01/15 huy Chromeで印刷できるように修正
	// イベントの設定 (onafterprint)
	window.onafterprint = function ( event ) {
		document.frm.target = "main";
		document.frm.action = "sei0150_23_bottom.asp"
		document.frm.submit();
	}
	//ADD END 2020/01/15 huy Chromeで印刷できるように修正
//-->
</SCRIPT>
<style TYPE="text/css">
table.hyo1 {
...
<form name="frm" method="post">
	...
	<table aling="center">
		...
		<tr>
			<td class="head3" aling="right"><%=f_ConvWareki_Nendo(m_iNendo)%></td>
			...
			<td>
				<table class="hyo1" align="center" border="1">
					...
					<tr>
						...
						<td class="head1" rowspan="2" align="center" nowrap>前期</td>	<!-- 2022.09.27 UPD head2 → head1 -->
						...
						<td class="head1" rowspan="2" align="center" nowrap>後期</td>	<!-- 2022.09.27 UPD head2 → head1 -->
						<td class="head1" colspan="5" rowspan="2"  align="center" nowrap>
							<table>
								<tr>
									<td class="head1" width="85" align="center" nowrap><!-- <%=Session("USER_NM")%> --></td>
						...
						<td class="head1" rowspan="2" align="center" nowrap>学年</td>	<!-- 2022.09.27 UPD head2 → head1 -->
						<td class="head1" colspan="5" rowspan="2"  align="center" nowrap>
							<table class = "gakunenHyo">
								<tr>
									<td class="head1" width="85" align="center" nowrap><!-- <%=Session("USER_NM")%> --></td>
									<td class="head1" align="right" nowrap><!-- 印 --></td>
								</tr>
					...
					<tr>
						...
						<td class="head1" rowspan="4" align="center" width="20" nowrap><div>名</div><div>列<div><div>番</div><div>号<div></td>
						<!-- 2022.09.27 UPD ED -->
...
<% '2009/06/15 upd iwata 授業時数の表示変更　免除科目の学生かどうかチェックする
   '	m_Rs("J_JUNJI_KT")=>w_sJ_JunJikan_KT,m_Rs("J_JUNJI_KK")=>w_sJ_JunJikan_KK 変更 %>
					...
					<tr>
						...
						<td class="head1" align="center" rowspan="2" nowrap>欠課</td>	<!-- 2022.09.27 UPD head2 → head1 -->
						<td class="head1" align="center" rowspan="2" nowrap>忌引</td>	<!-- 2022.09.27 UPD head2 → head1 -->
						<td class="head1" align="center" rowspan="2" nowrap>停止</td>	<!-- 2022.09.27 UPD head2 → head1 -->
						<td class="head1" align="center" rowspan="2" nowrap>派遣</td>	<!-- 2022.09.27 UPD head2 → head1 -->
						<td class="head1" align="center" rowspan="2" nowrap>欠課</td>	<!-- 2022.09.27 UPD head2 → head1 -->
						<td class="head1" align="center" rowspan="2" nowrap>忌引</td>	<!-- 2022.09.27 UPD head2 → head1 -->
						<td class="head1" align="center" rowspan="2" nowrap>停止</td>	<!-- 2022.09.27 UPD head2 → head1 -->
						<td class="head1" align="center" rowspan="2" nowrap>派遣</td>	<!-- 2022.09.27 UPD head2 → head1 -->
						...
						<td class="head1" align="center" rowspan="2" nowrap>停止</td>	<!-- 2022.09.27 UPD head2 → head1 -->
						<td class="head1" align="center" rowspan="2" nowrap>派遣</td>	<!-- 2022.09.27 UPD head2 → head1 -->
						<td class="head1" align="center" rowspan="2" nowrap>前期</td>	<!-- 2022.09.27 UPD head2 → head1 -->
						<td class="head1" align="center" rowspan="2" nowrap>後期</td>	<!-- 2022.09.27 UPD head2 → head1 -->
						<td class="head1" align="center" rowspan="2" nowrap>学年</td>	<!-- 2022.09.27 UPD head2 → head1 -->
					</tr>
					<tr>
