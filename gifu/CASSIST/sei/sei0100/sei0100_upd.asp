		...
		Select Case p_sSikenKBN
			...
			Case C_SIKEN_ZEN_TYU
				if request("hidUpdFlg" & i ) Then
					...
					w_sSQL = w_sSQL & vbCrLf & " 	T16_HTEN_TYUKAN_Z		= " & f_CnvNumNull(request("Seiseki"&i)) & ", "
			...
			Case C_SIKEN_ZEN_KIM
				if request("hidUpdFlg" & i ) Then
					...
					w_sSQL = w_sSQL & vbCrLf & " 	T16_HTEN_KIMATU_Z		= " & f_CnvNumNull(request("Seiseki"&i)) & ", "
			...
			Case C_SIKEN_KOU_TYU
				if request("hidUpdFlg" & i ) Then
					...
					w_sSQL = w_sSQL & vbCrLf & " 	T16_HTEN_TYUKAN_K		= " & f_CnvNumNull(request("Seiseki"&i)) & ", "
			...
			Case C_SIKEN_KOU_KIM
				if request("hidUpdFlg" & i ) Then
					...
					w_sSQL = w_sSQL & vbCrLf & " 	T16_HTEN_KIMATU_K		= " & f_CnvNumNull(request("Seiseki"&i)) & ", "
