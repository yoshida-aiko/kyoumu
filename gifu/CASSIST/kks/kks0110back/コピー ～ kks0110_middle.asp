...
'response.write w_sSQL & "<BR>"
        ...
        If w_Rs.EOF = false Then
            ...
            Do Until w_Rs.EOF
                ...
                iRet = f_Get_DateInfo(w_Rs("T32_HIDUKE"),w_Rs("T20_JIGEN"),w_bGyoji)
                If iRet <> 0 Then
                    msMsg = Err.description
                    f_Get_HeadData = 99
                    Exit Do
                ...
                If w_bGyoji <> True Then
                    ...
                    m_AryHead(3,i) = gf_SetNull2String(w_Rs("T20_JIGEN"))    '//時限
...
<% '表示メッセージ　パターンにより表示文字可変 %>
        ...
        <td align="center" valign="top" width="120" nowrap>
            ...
            <tr>
                ...
                <th height="20" colspan="2" class="header" nowrap align="center" width="60"><font color="#ffffff">期計</font></th>
            </tr>
            <tr>
                <th height="80" class="header" width="30" align="center" nowrap><font color="#ffffff">遅<br>刻</font></th>
                <th height="80" class="header" width="30" align="center" nowrap><font color="#ffffff">欠<br>席</font></th>
                <th height="80" class="header" width="30" align="center" nowrap><font color="#ffffff">遅<br>刻</font></th>
                <th height="80" class="header" width="30" align="center" nowrap><font color="#ffffff">欠<br>席</font></th>
            </tr>
            </table>
