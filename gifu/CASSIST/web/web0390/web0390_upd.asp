...
' システム名: 教務事務システム
' 処  理  名: レベル別科目決定
' ﾌﾟﾛｸﾞﾗﾑID : web/web0390/web0390_edt.asp
' 機      能: 下ページ レベル別科目決定の更新
'-------------------------------------------------------------------------
' 引      数: NENDO          '//処理年
'             KYOKAN_CD      '//教官CD
'             GAKUNEN        '//学年
...
Dim k
    ...
    Do 
        ...
        For k=1 To k_Max                '//学生Noを回す
                ...
                w_sLKyokan = request("L_KYOKAN"& k)
                w_sKamokuCd = request("cboKamokuCode")


                    w_sSQL = ""
                    w_sSQL = w_sSQL & " UPDATE T16_RISYU_KOJIN SET "
                    w_sSQL = w_sSQL & "   T16_LEVEL_KYOUKAN = '" & w_sLKyokan & "', "
...
//        document.frm.submit();
	...
	<input type="hidden" name="cboKamokuCode"      value="<%=Request("cboKamokuCode")%>">
