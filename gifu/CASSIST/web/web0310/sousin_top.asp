...
' システム名: 教務事務システム
' 処  理  名: 時間割交換連絡
' ﾌﾟﾛｸﾞﾗﾑID : web/web0310/sousin_top.asp
' 機      能: 上ページ 表示情報を表示
'-------------------------------------------------------------------------
...
<table class=hyo width=50%>
    <tr>
        <td align="center" width=15%><font color="white">内　容</font></td>
        <td class=detail width=90%><%=m_sNaiyou%></td>
    </tr>
</table>
<BR>
                    ...
                    <td align="left" class=search>
                        <table border="0" cellpadding="1" cellspacing="1" width="100%">
                            ...
                            <tr>
                                ...
                                <td widt=20% Nowrap>：
                                <%
                                call gf_ComboSet("Gakka",C_CBO_M02_GAKKA,"M02_NENDO='" & m_iNendo & "'",m_sGakkaOption,True,"")
                                %>
                                </td>
