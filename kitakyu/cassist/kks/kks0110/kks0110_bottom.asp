...
Function f_Get_AbsInfo_RuiKei()
	...
	Do 
		...
		w_bRtn = gf_GetStartEnd("kks",m_iSyoriNen,m_sSyubetu,cint(w_iSiken),m_sGakunen,w_GakusekiNo,m_sKamokuCd,w_sKaisibi,w_sSyuryobi,m_iShikenInsertType)
		'w_bRtn = gf_GetStartEnd("kks",m_iSyoriNen,cint(w_iSiken),m_sGakunen,w_GakusekiNo,m_sKamokuCd,w_sKaisibi,w_sSyuryobi,m_iShikenInsertType)
		If w_bRtn <> True Then
			Exit Function
		End If
...
'response.write(m_Rs_M("GAKUSEKI") & ":" & " T21 w_TukiKekka = " & w_TukiKekka & "<BR>")
...
'response.write(m_Rs_M("GAKUSEKI") & ":" & " T21 w_RuiKekka = " & w_RuiKekka & "<BR>")
...
'response.write(m_Rs_M("GAKUSEKI") & ":" & " T16 w_RuiKekka = " & w_RuiKekka & "<BR><BR>")
