				...
				<td valign="bottom" nowrap>
					<table class="hyo" border="1">
						<tr>
							...
							<th width="130" class="header" rowspan="2" nowrap>氏名</th>
							
							<% if not (m_Rs is nothing) then %>
								<% do until m_Rs.EOF %>
									<th width="40" class="header" align="center" nowrap><%=day(m_Rs("T21_HIDUKE"))%></td>
						...
						<tr>
							<% if not (m_Rs is nothing) then %>
								<% m_Rs.movefirst %>
								<% do until m_Rs.EOF %>
									<th width="40" class="header" align="center" nowrap><%=m_Rs("T21_JIGEN")%></td>
