...
'********************************************************************************
	...
	If session("KYOKAN_CD") = "" Then
		m_sKyokanCd = application("KYOKAN_CD")
	End If
            ...
            For i=1 to w_iMax
                ...
                If request("gakuNo" & i ) <> "" Then
                    ...
                    If request("Before" & i ) = "" Then
                        ...
                        w_sSQL = w_sSQL & vbCrLf & "   T06_IIN_KBN, "
						...
						w_sSQL = w_sSQL & vbCrLf & "   " & request("cboGakki") & " ,"
                    ...
                    ElseIf request("gakuNo" & i ) <> request("Before" & i ) Then
                        ...
                        w_sSQL = w_sSQL & vbCrLf & "    AND T06_IIN_KBN = 2 "
						w_sSQL = w_sSQL & vbCrLf & "	AND T06_GAKKI_KBN = " & request("cboGakki") & " "
...
%>
    ...
    function window_onload() {
        ...
        location.href = "./default.asp?cboGakki=<%=Request("cboGakki")%>"
        return;
    }
    //-->
    </SCRIPT>
