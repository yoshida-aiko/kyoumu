    ...
    <td align="center">
        ...
        <tr>
			...
			<td width="50" class="detail">
				<select name="cboGakki" onchange="javascript:f_ReLoadMyPage()">
					<Option Value="<%=C_GAKKI_ZENKI%>" <%=f_Selected(C_GAKKI_ZENKI,m_iGAKKIKBN)%>>前期
					<Option Value="<%=C_GAKKI_KOUKI%>" <%=f_Selected(C_GAKKI_KOUKI,m_iGAKKIKBN)%>>後期
				</select>
				</td>
        </tr>
        </table></td>
