...
<!--
        ...
        function iinSelect(p_sct,p_No) {
            ...
            //挿入させたいフォームを取得
                w_NmStr = opener.document.frm.elements[p_NoNm];
                w_NoStr = opener.document.frm.elements[p_NoNo];
            ...
            //挿入処理
                ...
                document.frm.SearchNm.value = w_NmStr.value;
                document.frm.SearchNo.value = w_NoStr.value;
...
<table border="0" cellpadding="1" cellspacing="1" width="500">
	...
	<tr>
		<td align="center" width="250" valign="top">
		    ...
		    <tr>
		        <th width="80"  class="header" nowrap>学籍No.</th>
