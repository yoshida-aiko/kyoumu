...
Sub s_MakeSQL(p_sSql)
    ...
    p_sSql = p_sSql & " ,A.T13_GAKUSEKI_NO||'/'|| A.T13_GAKUNEN||'年/'||C.M02_GAKKARYAKSYO"													'add 2017/03/01 m.tou WEBアクセスログカスタマイズ
    p_sSql = p_sSql & "||'/'||E.M05_CLASSMEI||'/'||B.T11_SIMEI||'/'||D.M01_SYOBUNRUIMEI||'/'||A.T13_GAKUSEI_NO  LOG_TAISYO    "			'add 2017/03/01 m.tou WEBアクセスログカスタマイズ
...
<link rel=stylesheet href=../../common/style.css type=text/css>
    ...
    //
    //************************************************************
    function f_detail(pGAKUSEI_NO,p_taisyo){		//add 2017/03/01 m.tou
//    function f_detail(pGAKUSEI_NO){		//del 2017/03/01 m.tou
