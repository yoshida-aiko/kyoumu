...
'    Dim     m_sSyumiTokugi  '//趣味等
    ...
    Dim     m_sNSyoken      '//年毎所見
    Dim     m_sNSyoken2     '//年毎所見
    Dim     m_sNSyoken3     '//年毎所見
    Dim     m_sNendo        '//
    Dim     m_sGakuNo       '//学生No
    Dim     m_sGakunen
    Dim     m_sClass
...
'    m_sSyumiTokugi  = request("SyumiTokugi")
    ...
    m_sNSyoken2     = request("NSyoken2")
    m_sNSyoken3     = request("NSyoken3")
...
'            w_sSQL = w_sSQL & vbCrLf & "   T11_SYUMITOKUGI = '"  & Trim(m_sSyumiTokugi) & "' ,"
            ...
            w_sSQL = w_sSQL & vbCrLf & "   T13_NENSYOKEN2 = '"  & Trim(m_sNSyoken2) & "' ,"
            w_sSQL = w_sSQL & vbCrLf & "   T13_NENSYOKEN3 = '"  & Trim(m_sNSyoken3) & "' ,"
