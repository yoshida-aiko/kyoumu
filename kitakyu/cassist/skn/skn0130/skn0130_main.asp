...
''		w_sSql = w_sSql & vbCrLf & " FROM M05_CLASS M05 , T27_TANTO_KYOKAN T27, T15_RISYU T15"		
		w_sSql = w_sSql & vbCrLf & " WHERE "
...
''		w_sSql = w_sSql & vbCrLf & "  AND T27.T27_KAMOKU_CD = T15.T15_KAMOKU_CD "
''		w_sSql = w_sSql & vbCrLf & "  AND T15.T15_NYUNENDO = T27.T27_NENDO - T27.T27_GAKUNEN + 1"
''		w_sSql = w_sSql & vbCrLf & "  AND (T15.T15_KAISETU" & p_iGakuNen & " =" & w_sJiki & " OR T15.T15_KAISETU" & p_iGakuNen & " =" & C_KAI_TUNEN & " )"
		'2011/12/26 Add End
...
Function f_GetSikenJikan(p_iNendo,p_iGakuNen,p_Kamoku,p_sSikenJikan,p_sSJissi,p_sKyositu)
    ...
    Do
        ...
        w_sSql = w_sSql & vbCrLf & "  AND T26_MAIN_FLG = 1 "
'response.write w_ssql & "<br>"
