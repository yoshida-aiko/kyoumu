...
Public Const C_IDO_NYUGAKU = 15     '入学	2002.10.17
Public Const C_IDO_TENNYU = 16		'転入   2002.10.17
...
'2011/12/26 Add
Public Const C_K_KYOSHITUYOYAKU_FROM = 46		'教室予約開始日
Public Const C_K_KYOSHITUYOYAKU_TO = 47			'教室予約終了日
'***********************
'管理マスタ（種別情報）
'***********************
'年度
...
'成績入力方法
Public Const C_SEISEKI_INP_TYPE_NUM = 0			'点数
Public Const C_SEISEKI_INP_TYPE_STRING = 1		'文字
