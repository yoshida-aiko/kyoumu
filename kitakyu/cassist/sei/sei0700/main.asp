...
Function f_GetGakkaGrp(p_iNendo,p_sGakkaCd)
	...
	Set m_RsGakka = Server.CreateObject("ADODB.Recordset")
	'//ﾚｺｰﾄﾞｾｯﾄ取得
	If gf_GetRecordset(m_RsGakka, w_sSQL) <> 0 Then
		'ﾚｺｰﾄﾞｾｯﾄの取得失敗
		Exit Function
	End If
						...
						<!-- UPD END   2017/03/01 m.tou WEBアクセスログカスタマイズ -->
							...
							%>
								<tr>
									...
									<!-- <td align="center" height="16" class=<%=w_cell%> width="100"nowrap><a onclick="f_download('<%=gf_HTMLTableSTR(m_Rs("LOG_TAISYO")) %>');">Download</a></td> -->
