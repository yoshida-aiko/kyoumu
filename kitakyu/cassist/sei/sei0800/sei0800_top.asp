...
'			w_sSQL = w_sSQL & vbCrLf & "    AND M05_GAKKA_CD(+) = T16_GAKKA_CD "　DEL 2017.12.22 Nishimura 1クラスに複数学科が存在するのでコースCDでリンクするように修正
...
'			w_sSQL = w_sSQL & vbCrLf & "    AND T16_COURSE_CD IN ( '0' , CASE WHEN M05_COURSE_CD IS NOT NULL THEN M05_COURSE_CD ELSE T16_COURSE_CD END) " '2017.12.22 Ins Nishimura
			w_sSQL = w_sSQL & vbCrLf & "    AND T16_COURSE_CD IN ( '0' , CASE WHEN M05_GAKKA_CD = T16_GAKKA_CD THEN (CASE WHEN M05_COURSE_CD IS NOT NULL THEN M05_COURSE_CD ELSE T16_COURSE_CD END ) ELSE T16_COURSE_CD END ) " '2019.02.12 Upd Kiyomoto
