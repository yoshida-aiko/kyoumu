...
' システム名: 教務事務システム
' 処  理  名: 仮進級者成績登録
' ﾌﾟﾛｸﾞﾗﾑID : sei/sei0900/default.asp
...
<frameset rows=245px,1,* frameborder="0" framespacing="0">
	<!--<frame src="sei0900_top.asp" scrolling="auto"  name="top" noresize>-->
	<frame src="sei0900_top.asp" scrolling="yes"  name="topFrame" noresize>
