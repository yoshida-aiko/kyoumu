...
-->
	...
	'					response.write " C "
			...
			'If cint(m_iLevelFlg) = 1 Then
			'	if cint(gf_SetNull2Zero(m_Rs("T16_SELECT_FLG"))) = 0 Then
			'		w_bNoChange = True
			'	End if
			'End If 
	...
	<%
			...
			If w_bNoChange = True Then%>
				...
				<%if m_TUKU_FLG = C_TUKU_FLG_TUJO Then%>
							...
							<td class="<%=w_cell%>" width="38" ><%=w_sGakusekiCd%></td>
							<td class="<%=w_cell%>" align="left"   width="219"><%=m_Rs("SIMEI")%><%=w_SSSS%></td>
							<td class="<%=w_cell%>" align="center" width="32">-</td>
							<td class="<%=w_cell%>" align="center" width="32">-</td>
							<td class="<%=w_cell%>" align="center" width="23">-</td>
							<td class="<%=w_cell%>" align="center" width="23">-</td>
							<td class="<%=w_cell%>" align="center" width="23">-</td>
							<td class="<%=w_cell%>" align="center" width="23">-</td>
							<td class="<%=w_cell%>" align="center" width="34">-</td>

				<%Else%>

							<td class="<%=w_cell%>" width="38" ><%=w_sGakusekiCd%></td>
							<td class="<%=w_cell%>" align="left"   width="219" nowarap><%=m_Rs("SIMEI")%><%=w_SSSS%></td>
							<td class="<%=w_cell%>" align="center" width="30">-</td>
							<td class="<%=w_cell%>" align="center" width="30">-</td>
							<td class="<%=w_cell%>" align="center"width="60">-</td>
							<td class="<%=w_cell%>" align="center"width="45">-</td>
							<td class="<%=w_cell%>" align="center"width="45">-</td>
			...
			Else
				%>
						<td class="<%=w_cell%>"  width="38"><%=w_sGakusekiCd%>
						<input type="hidden" name=txtGseiNo<%=i%> value="<%=m_Rs("GAKUSEI_NO")%>"></td>
						<td class="<%=w_cell%>" align="left"  width="219" nowarap><%=m_Rs("SIMEI")%></td>
				...
				<%If m_iKikan <> "NO" Then%>
					<%If m_TUKU_FLG = C_TUKU_FLG_TUJO Then%>
						...
						<td class="<%=w_cell%>" width="32"><input type="text" <%=w_sInputClass%>  name=Seiseki<%=i%> value="<%=w_sSeiseki%>" size=2 maxlength=3 onKeyDown="f_MoveCur('Seiseki',this.form,<%=i%>)"></td>
						<%If m_sSikenKBN = C_SIKEN_ZEN_TYU or m_sSikenKBN = C_SIKEN_KOU_TYU Then%>

								<td class="<%=w_cell%>"  width="32"><input type="button" size="2" name="button<%=i%>" value="<%=w_sHyoka%>" onClick="return f_change(<%=i%>)" style="text-align:center" class="<%=w_cell%>"><!-- class="<%=w_cell%>"-->
								<input type="hidden" name="Hyoka<%=i%>" value="<%=trim(w_sHyoka)%>"></td>

						<%Else%>

								<td class="<%=w_cell%>"  width="32"><%=w_sHyoka%><input type="hidden" name="Hyoka<%=i%>" value="<%=trim(w_sHyoka)%>"></td>

						<%End If%>
							<td class="<%=w_cell%>" width="23"><input type="text" <%=w_sInputClass%>  name=Chikai<%=i%> value="<%=w_sChikai%>" size=1 maxlength=2 onKeyDown="f_MoveCur('Chikai',this.form,<%=i%>)"></td>
							<td class="<%=w_cell%>" width="23"align="right"><%=w_sChikaisu%></td>
							<td class="<%=w_cell%>" width="28"><input type="text" <%=w_sInputClass%>  name=Kekka<%=i%> value="<%=w_sKekka%>" size=2 maxlength=3 onKeyDown="f_MoveCur('Kekka',this.form,<%=i%>)"></td>
							<td class="<%=w_cell%>" width="28"><input type="text" <%=w_sInputClass%>  name=KekkaGai<%=i%> value="<%=w_sKekkaGai%>" size=2 maxlength=3 onKeyDown="f_MoveCur('KekkaGai',this.form,<%=i%>)"></td>
							<td class="<%=w_cell%>" width="32"align="right"><%=w_sKekkasu%></td>
					<%Else%>
							<td class="<%=w_cell%>" align="center" width="30">-</td>
							<td class="<%=w_cell%>" align="center" width="30">-</td>
				...
				<%Else%>
					...
					<%If m_TUKU_FLG = C_TUKU_FLG_TUJO Then%>
						...
						<td class="<%=w_cell%>" width="32" align="right"><%=w_sSeiseki%></td>
						
						<%If m_sSikenKBN = C_SIKEN_ZEN_TYU or m_sSikenKBN = C_SIKEN_KOU_TYU Then%>
								<td class="<%=w_cell%>"  width="32" align="center"><%=trim(w_sHyoka)%></td>
						<%Else%>
								<td class="<%=w_cell%>"  width="32" align="center"><%=trim(w_sHyoka)%></td>
						<%End If%>
							<td class="<%=w_cell%>" width="23" align="right"><%=w_sChikai%></td>
							<td class="<%=w_cell%>" width="23" align="right"><%=w_sChikaisu%></td>
							<td class="<%=w_cell%>" width="28" align="right"><%=w_sKekka%></td>
							<td class="<%=w_cell%>" width="28" align="right"><%=w_sKekkaGai%></td>
							<td class="<%=w_cell%>" width="32" align="right"><%=w_sKekkasu%></td>
					<%Else%>
							<td class="<%=w_cell%>" align="center" width="30">-</td>
							<td class="<%=w_cell%>" align="center" width="30">-</td>
							<td class="<%=w_cell%>" width="60" align="right"><%=w_sChikai%></td>
							<td class="<%=w_cell%>" width="45" align="right"><%=w_sKekka%></td>
							<td class="<%=w_cell%>" width="45" align="right"><%=w_sKekkaGai%></td>
