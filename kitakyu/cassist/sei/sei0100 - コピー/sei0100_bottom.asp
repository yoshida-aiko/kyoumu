...
Sub s_SetParam()
	...
	m_sClassNo	= request.form("txtClassNo")
...
Response.Write("txtGakuNo=" & request("txtGakuNo") & "<BR>")
Response.Write("txtClassNo=" & request("txtClassNo") & "<BR>")
Response.Write("txtKamokuCd=" & request("txtGakkaCd") & "<BR>")	
End Sub
