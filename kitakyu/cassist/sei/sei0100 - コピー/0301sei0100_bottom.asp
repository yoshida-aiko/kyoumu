...
<!--
	...
	<td valign="top">
-->
		<table class="hyo" border="1" align="center" width="560" nowrap>
	<%	m_Rs.MoveFirst
		Do Until m_Rs.EOF
...
'response.write "遅刻数累計 : " & w_sChikaisu
	...
	<%
			...
			If w_bNoChange = True Then%>
				<%
				if Cstr(m_TUKU_FLG) = Cstr(C_TUKU_FLG_TUJO) Then%>
							<td class="<%=w_cell%>" width="40" nowrap><%=w_sGakusekiCd%></td>
			...
			Else
				%>
						<td class="<%=w_cell%>"  width="40" nowrap><%=w_sGakusekiCd%>
				...
				<%If m_iKikan <> "NO" Then%>
					<%If m_TUKU_FLG = C_TUKU_FLG_TUJO Then%>
						...
						<td class="<%=w_cell%>" width="35"align="center" nowrap><input type="text" <%=w_sInputClass%>  name=Seiseki<%=i%> value="<%=w_sSeiseki%>" size=2 maxlength=3 onKeyDown="f_MoveCur('Seiseki',this.form,<%=i%>)" onChange="f_GetTotalAvg()"></td>
						...
						<%End If%>
							<td class="<%=w_cell%>" width="35" align="center" nowrap><input type="text" <%=w_sInputClass%>  name=Chikai<%=i%> value="<%=w_sChikai%>" size=1 maxlength=2 onKeyDown="f_MoveCur('Chikai',this.form,<%=i%>)"></td>
							<td class="<%=w_cell%>" width="45" align="right" nowrap><%=w_sChikaisu%></td>
							<td class="<%=w_cell%>" width="35" align="center" nowrap><input type="text" <%=w_sInputClass%>  name=Kekka<%=i%> value="<%=w_sKekka%>" size=2 maxlength=3 onKeyDown="f_MoveCur('Kekka',this.form,<%=i%>)"></td>
							<td class="<%=w_cell%>" width="40" align="center" nowrap><input type="text" <%=w_sInputClass%>  name=KekkaGai<%=i%> value="<%=w_sKekkaGai%>" size=2 maxlength=3 onKeyDown="f_MoveCur('KekkaGai',this.form,<%=i%>)"></td>
							<td class="<%=w_cell%>" width="45" align="right" nowrap><%=w_sKekkasu%></td>
					<%Else%>
							<td class="<%=w_cell%>" width="35" nowrap align="center">-</td>
							<td class="<%=w_cell%>" width="35" nowrap align="center">-</td>
							<td class="<%=w_cell%>" width="80" nowrap align="center"><input type="text" <%=w_sInputClass%>  name=Chikai<%=i%> value="<%=w_sChikai%>" size=2 maxlength=2 onKeyDown="f_MoveCur('Chikai',this.form,<%=i%>)"></td>
							<td class="<%=w_cell%>" width="60" nowrap align="center"><input type="text" <%=w_sInputClass%>  name=Kekka<%=i%> value="<%=w_sKekka%>" size=2 maxlength=3 onKeyDown="f_MoveCur('Kekka',this.form,<%=i%>)"></td>
							<td class="<%=w_cell%>" width="60" nowrap align="center"><input type="text" <%=w_sInputClass%>  name=KekkaGai<%=i%> value="<%=w_sKekkaGai%>" size=2 maxlength=3 onKeyDown="f_MoveCur('KekkaGai',this.form,<%=i%>)"></td>
					<%End If%>
				...
				<%Else%>
					...
					<%If m_TUKU_FLG = C_TUKU_FLG_TUJO Then%>
						...
						<td class="<%=w_cell%>" width="35" align="right" nowrap><%=w_sSeiseki%></td>
						...
						<%Else%>
								<td class="<%=w_cell%>"  width="35" align="center" nowrap><%=trim(w_sHyoka)%></td>
						<%End If%>
							<td class="<%=w_cell%>" width="35" align="right" nowrap><%=w_sChikai%></td>
							<td class="<%=w_cell%>" width="45" align="right" nowrap><%=w_sChikaisu%></td>
							<td class="<%=w_cell%>" width="35" align="right" nowrap><%=w_sKekka%></td>
							<td class="<%=w_cell%>" width="40" align="right" nowrap><%=w_sKekkaGai%></td>
							<td class="<%=w_cell%>" width="45" align="right" nowrap><%=w_sKekkasu%></td>
					<%Else%>
							<td class="<%=w_cell%>" width="35" align="center" nowrap>-</td>
							<td class="<%=w_cell%>" width="35" align="center" nowrap>-</td>
							<td class="<%=w_cell%>" width="80" align="right" nowrap><%=w_sChikai%></td>
							<td class="<%=w_cell%>" width="60" align="right" nowrap><%=w_sKekka%></td>
							<td class="<%=w_cell%>" width="60" align="right" nowrap><%=w_sKekkaGai%></td>
			...
			<tr>
				<td class="header" nowrap align="right" colspan="3">
