...
<table align="center" cellspacing="0" cellpadding="0" width=100% height=100% border="0">
	...
	<tr>
		<td align="center" valign="middle">
			...
			<table align="center" class=manual cellspacing="0" cellpadding="0" width=450 height=100% border="0">
				<tr>
					<td class=manual colspan="2" width="450" height="35%" align="center">
					<img src="img/topimage.jpg">
					</td>
				</tr>
				<tr>
					<td class=manual align="right" valign="top" height="65%" >
...
-->
						...
						<td valign="top">
							...
							<table width=150 cellspacing="1" cellpadding="1" border="0">
								<tr>
									<td class=manual><b>3・試験・成績</b></td>
								</tr>
<!--								<tr>
									<td class=manual><img src="../image/sp.gif" width="5" height="1">
...
-->
								<tr>
									<td class=manual><img src="../image/sp.gif" width="5" height="1">
									<a href="javascript:f_PageClick(11)">試験毎所見登録</a></td>
								</tr>
<!--								<tr>
									<td class=manual><img src="../image/sp.gif" width="5" height="1">
