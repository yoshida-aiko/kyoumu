...
' システム名: 教務事務システム
' 処  理  名: 放送大学成績登録
' ﾌﾟﾛｸﾞﾗﾑID : sei/sei0160/default.asp
' 機      能: 
'-------------------------------------------------------------------------
...
<frameset rows=180px,1,* frameborder="0" framespacing="0">
	<frame src="sei0160_top.asp" scrolling="yes"  name="topFrame" noresize>
