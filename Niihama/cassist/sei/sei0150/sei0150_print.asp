...
' システム名: 教務事務システム
' 処  理  名: 成績登録
' ﾌﾟﾛｸﾞﾗﾑID : sei/sei0150/sei0150_print.asp
' 機      能: 成績登録の印刷用ウィンドウ
'-------------------------------------------------------------------------
...
Function f_GetKamokuName(p_Gakunen,p_GakkaCd,p_KamokuCd)
	...
	If Cstr(m_iKamokuKbn) = Cstr(C_TUKU_FLG_TUJO) Then '通常授業と特別活動で取り先を変える。
		w_sSQL = w_sSQL & " SELECT "
		...
		<tr>
			<td align="center" nowrap>
				<table style="border-layout:fixed;border-collapse:collapse;border-style:solid;border-color:#000000;border-width:1px;padding:0px;margin:0px;" border="1" align="center" width="<%=w_TableWidth%>">
					<caption>成績登録印刷</caption>
					<tr>
						<td style="<%=w_Style%>" align="center" nowrap >成績入力期間</td>
						<td style="<%=w_Style%>" align="center"><%=f_ShikenMei()%></td>
						<td style="<%=w_Style%>" align="center" nowrap>出力日</td>
						<td style="<%=w_Style%>" align="center"><%=FormatTime(now(),"YYYY/MM/DD HH24:II:SS")%></td>
						<td style="<%=w_Style%>" align="center" nowrap>ユーザー名</td>
						<td style="<%=w_Style%>" align="center"><%=Session("USER_NM")%></td>
					</tr>
					<tr>
						<td style="<%=w_Style%>" align="center" nowrap>実施科目</td>
						
						<%
						w_str = m_sGakuNo & "年　" & gf_GetClassName(m_iNendo,Cint(m_sGakuNo),m_sClassNo) & "　" & f_GetKamokuName(Cint(m_sGakuNo),m_sGakkaCd,m_sKamokuCd)
						%>
				...
				<table style="border-layout:fixed;border-collapse:collapse;border-style:solid;border-color:#000000;border-width:1px;padding:0px;margin:0px;" border="1" align="center" width="<%=w_TableWidth%>">
					...
					<tr>
						<td style="<%=w_Style%>" align="center" nowrap colspan="9">
							総授業数&nbsp;&nbsp;<%= m_iSouJyugyou %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;純授業数&nbsp;&nbsp;<%= m_iJunJyugyou %></td>
					</tr>
					<tr>
						<td style="<%=w_Style%>" align="center" rowspan="2" width="75" nowrap><%=gf_GetGakuNomei(m_iNendo,C_K_KOJIN_1NEN)%></td>
						<td style="<%=w_Style%>" align="center" rowspan="2" width="150" nowrap>氏　名</td>
						<td style="<%=w_Style%>" align="center" colspan="4" width="200" nowrap>成績履歴</td>

						<td style="<%=w_Style%>" align="center" rowspan="2" width="65" nowrap>成績</td>
						<td style="<%=w_Style%>" align="center" rowspan="2" width="65" nowrap>遅刻</td>
						<td style="<%=w_Style%>" align="center" rowspan="2" width="65" nowrap>欠課</td>
					</tr>

					<tr>
						<td style="<%=w_Style%>" align="center" width="50" nowrap>前中</td>
						<td style="<%=w_Style%>" align="center" width="50" nowrap>前末</td>
						<td style="<%=w_Style%>" align="center" width="50" nowrap>後中</td>
						<td style="<%=w_Style%>" align="center" width="50" nowrap>学末</td>
...
<tr>
	    ...
	    <td style="<%=w_Style2%>" align="left" width="150" nowrap>だみー</td>
...
-->
      <% if m_iSeisekiInpType = C_SEISEKI_INP_TYPE_NUM then %>
        <tr>
          <td style="<%=w_Style%>" align="right" colspan="6" nowrap >合計</td>
        ...
        <tr>
          <td style="<%=w_Style%>" align="right" colspan="6" nowrap>平均点</td>
		  <%
      ...
      <% else %>
        <tr>
          <td style="<%=w_Style%>" align="center" colspan="7" nowrap>合計</td>
