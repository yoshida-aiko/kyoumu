...
Function f_GetSubject()
	...
	if m_iSikenKbn <> C_SIKEN_KOU_KIM then
		...
		w_sSQL = w_sSQL & "		 or "
		w_sSQL = w_sSQL & "		 ("
		w_sSQL = w_sSQL & "			T15_KAISETU1 =" & 2 & " or "
		w_sSQL = w_sSQL & "			T15_KAISETU2 =" & 2 & " or "
		w_sSQL = w_sSQL & "			T15_KAISETU3 =" & 2 & " or "
		w_sSQL = w_sSQL & "			T15_KAISETU4 =" & 2 & " or "
		w_sSQL = w_sSQL & "			T15_KAISETU5 =" & 2
		w_sSQL = w_sSQL & "		 ) )"
	else
		w_sSQL = w_sSQL & " and	("
