...
'response.write "bb2<br>" & p_sSikenKbn & "<br>"
			'開始日
                        if p_sSikenKbn = 2 then
			    if not gf_GetShikenDate(w_iNendo,p_sGakunen,p_sSikenKbn,p_sKaisibi,"START") then : exit function
                        end if

                        if p_sSikenKbn = 3 then
			    if not gf_GetShikenDate(w_iNendo,p_sGakunen,p_sSikenKbn - 1,p_sKaisibi,"START") then : exit function
                        end if

'response.write "bb3<br>"
