...
Sub s_SetParam()
	...
	m_sFromDate = request("txtFromDate")
	m_sToDate = request("txtToDate")
						...
						<% Call gs_cellPtn(w_Class) %>
        					<tr>
					            ...
					            <% for j = 3 to m_AryXCount %>
					            	<td class="<%=w_Class%>" align="center" width="20" height="27" nowrap><%=gf_SetNull2Zero(m_AryKekka(j,i))%></td>
		            			<% next %>	
							</tr>
		            <%next%>
            	</table>
            ...
            <td align="center" width="120" valign="top" nowrap>
				...
				<table width="120" class="hyo" border="1">
		            ...
		            <% for w_kei_num=0 to m_StudentCount %>
			            ...
			            <tr>
			            	<td class="<%=w_Class%>" align="center" width="30" height="27" nowrap><%=gf_SetNull2Zero(m_AryKei(0,w_kei_num))%></td>
				            <td class="<%=w_Class%>" align="center" width="30" height="27" nowrap><%=gf_SetNull2Zero(m_AryKei(1,w_kei_num))%></td>
				            <td class="<%=w_Class%>" align="center" width="30" height="27" nowrap><%=gf_SetNull2Zero(m_AryKei(2,w_kei_num))%></td>
				            <td class="<%=w_Class%>" align="center" width="30" height="27" nowrap><%=gf_SetNull2Zero(m_AryKei(3,w_kei_num))%></td>
			            </tr>
