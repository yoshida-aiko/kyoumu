...
'******************************************************************
    ...
    Do
		...
		m_sSQL = m_sSQL & vbCrLf & "  ,M04_KYOKAN.M04_KYOKANMEI_KANA_SEI "
		m_sSQL = m_sSQL & vbCrLf & "  ,M04_KYOKAN.M04_KYOKANMEI_KANA_MEI "
		...
		m_sSQL = m_sSQL & vbCrLf & "  AND M10_USER.M10_USER_ID <> 'infogram' "
		...
		m_sSQL = m_sSQL & vbCrLf & "  M10_USER_KBN,"
		m_sSQL = m_sSQL & vbCrLf & "  M04_GAKKA_CD,"
		m_sSQL = m_sSQL & vbCrLf & "  M04_KYOKAN_KBN,"
		m_sSQL = m_sSQL & vbCrLf & "  M04_KYOKANMEI_KANA_SEI,"
		m_sSQL = m_sSQL & vbCrLf & "  M04_KYOKANMEI_KANA_MEI,"
		m_sSQL = m_sSQL & vbCrLf & "  M10_USER_NAME,"
		m_sSQL = m_sSQL & vbCrLf & "  M04_KYOKAKEIRETU_KBN "
...
<div align="center"><span class=CAUTION>※ 送付したい人にチェックをつけて｢選択完了｣ボタンをクリックします。<br>
	...
	<td align="center" width=50% valign="top">
	    ...
	    <tr>
	        ...
	        <th width=26% class=header>教官</th>
	        <th width=5% class=header>学科</th>
	        <th width=20% class=header>教科系</th>
	        <th width=44% class=header>氏名</th>
	    </tr>
	    <%
        m_rs.MoveFirst
...
<td align="center" width=50% valign="top">
    ...
    <%
            ...
            w_schk=""
            Do Until m_Srs.EOF
                If m_rs("M10_USER_ID") = m_Srs("T46_KYOKAN_CD") Then
                    w_schk=" checked"
                    Exit Do
                End If
            m_Srs.MoveNext
