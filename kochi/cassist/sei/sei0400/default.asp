...
'システム名     ：教務事務システム
'処　理　名     ：試験毎所見登録
'プログラムID   ：gak/sei0400/default.asp
...
<html>
    ...
    <frameset rows=180,1,* frameborder="0" FRAMESPACING="0" border="0">
        <frame src="sei0400_top.asp?txtGakuNo=<%=request("txtGakuNo")%>&txtSikenKBN=<%=m_iSikenKBN%>" scrolling="auto" noresize name="topFrame">
...
<% response.end %>
    <frameset rows=180,1,* frameborder="0" FRAMESPACING="0" border="0">
        <frame src="sei0400_top.asp?txtGakuNo=<%=m_sGakuNo%>&txtSikenKBN=<%=m_iSikenKBN%>" scrolling="auto" noresize name="topFrame">
        <frame src="../../common/bar.html" scrolling="auto" noresize name="bar">
        <frame src="sei0400_main.asp?txtGakuNo=<%=m_sGakuNo%>&txtGakunen=<%=m_sGakunen%>&txtClass=<%=m_sClass%>&txtClassNm=<%=m_sClassNm%>&txtSikenKBN=<%=m_iSikenKBN%>" scrolling="auto" noresize name="main">
    </frameset>
    </head>
</html>
<%
