...
<!--#include file="sei0150_upd_func.asp"-->
<%
'/////////////////////////// ﾓｼﾞｭｰﾙ変数 /////////////////////////////
    'エラー系
		...
		For i=1 to i_max
			...
			Select Case p_sSikenKBN
				...
				Case C_SIKEN_ZEN_TYU
					...
					w_sSQL = w_sSQL & " T16_SOJIKAN_TYUKAN_Z    = " & f_CnvNumNull(m_iSouJyugyou)  & ","
					w_sSQL = w_sSQL & " T16_JUNJIKAN_TYUKAN_Z   = " & f_CnvNumNull(m_iJunJyugyou)  & ","
					w_sSQL = w_sSQL & " T16_J_JUNJIKAN_TYUKAN_Z = " & f_CnvNumNull(m_iJituJyugyou) & ","
				...
				Case C_SIKEN_ZEN_KIM
					...
					if not request("hidNoChange" & i ) Then
						...
						'	w_sSQL = w_sSQL & " T16_HYOKAYOTEI_KIMATU_Z	= '" & request("Hyoka"&i) & "', "
						'end if
					...
					w_sSQL = w_sSQL & " T16_SOJIKAN_KIMATU_Z    = " & f_CnvNumNull(m_iSouJyugyou)  & ","
					w_sSQL = w_sSQL & " T16_JUNJIKAN_KIMATU_Z   = " & f_CnvNumNull(m_iJunJyugyou)  & ","
					w_sSQL = w_sSQL & " T16_J_JUNJIKAN_KIMATU_Z = " & f_CnvNumNull(m_iJituJyugyou) & ","
				...
				Case C_SIKEN_KOU_TYU
					...
					w_sSQL = w_sSQL & " T16_SOJIKAN_TYUKAN_K    = " & f_CnvNumNull(m_iSouJyugyou)  & ","
					w_sSQL = w_sSQL & " T16_JUNJIKAN_TYUKAN_K   = " & f_CnvNumNull(m_iJunJyugyou)  & ","
					w_sSQL = w_sSQL & " T16_J_JUNJIKAN_TYUKAN_K = " & f_CnvNumNull(m_iJituJyugyou) & ","
				...
				Case C_SIKEN_KOU_KIM
					...
					if not request("hidNoChange" & i ) Then
						...
						'if m_bSeiInpFlg then
						'	w_sSQL = w_sSQL & " T16_HYOKAYOTEI_KIMATU_K	= '" & request("Hyoka"&i) & "', "
						'end if
					...
					w_sSQL = w_sSQL & " T16_SOJIKAN_KIMATU_K    = " & f_CnvNumNull(m_iSouJyugyou)  & ","
					w_sSQL = w_sSQL & " T16_JUNJIKAN_KIMATU_K   = " & f_CnvNumNull(m_iJunJyugyou)  & ","
					w_sSQL = w_sSQL & " T16_J_JUNJIKAN_KIMATU_K = " & f_CnvNumNull(m_iJituJyugyou) & ","
