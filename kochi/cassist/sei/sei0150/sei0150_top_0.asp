...
'														If (gRs("KAMOKU_CD") = 140046 ) OR (gRs("KAMOKU_CD") = 140050 ) OR (gRs("KAMOKU_CD") = 140047 ) OR (gRs("KAMOKU_CD") = 140048 ) OR (gRs("KAMOKU_CD") = 180011 ) OR (gRs("KAMOKU_CD") = 180012 ) OR (gRs("KAMOKU_CD") = 180013 ) OR (gRs("KAMOKU_CD") = 180014 ) Then
'															w_SubjectDisp = w_SubjectDisp & f_GetGakkaNm(m_iNendo,gRs("GAKKA_CD"))  & "　"
'														Else
'															w_SubjectDisp = w_SubjectDisp & gRs("CLASS_NAME") & "　"
'														End If
