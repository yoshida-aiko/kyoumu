...
'*  [引数]  なし
'*  [戻値]  クラス名称
'*  [説明]  クラス名称を取得する。Add 2001.12.16 okada
'********************************************************************************
Function f_GetClass(p_sCLASS,p_iGakunen)
	...
	Do 
		...
		'If request("selNendo") = "" Then
			w_sSQL = w_sSQL & vbCrLf & "      M05_NENDO = " &  Session("HyoujiNendo")
		'Else
		'	w_sSQL = w_sSQL & vbCrLf & "      M05_NENDO = " & request("selNendo")
		'End If
				...
				<table border="1" class="disp">
					<tr>
						...
						<% if gf_empItem(C_T13_CLASS) then %>
							...
							<td class="disp" nowrap width="80"><%= f_GetClass(m_CLASS,m_GAKUNEN) %>&nbsp;</td>
						<% End if %>
